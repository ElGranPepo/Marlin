 ...
 */
   ...
   */
  //#define PID_FAN_SCALING //results in compile error
...
#define HOMING_BUMP_DIVISOR { 10, 10, 1 }  // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { HOMING_FEEDRATE_XY, HOMING_FEEDRATE_XY, HOMING_FEEDRATE_Z, HOMING_FEEDRATE_E } // Feedrates for manual moves along X, Y, Z, E from panel
...
#define BABYSTEPPING
  ...
  //#define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 
    #if ENABLED (TOUCHPROBE) || ENABLED (FMP) && DISABLED (GTM32)
 ...
 */
#if HAS_TRINAMIC //Does nothing unless drivers are wired up UART/SPI and not set standalone
