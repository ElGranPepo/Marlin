...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  //#define G26_MESH_VALIDATION  //Tested broken directly linked to max feed E
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET  30 // (mm) An inset for all sides corner leveling
...
#if ENABLED (BLTOUCH) || ENABLED (FMP)
...
// setting these to 0 will effectively mute the beeper
